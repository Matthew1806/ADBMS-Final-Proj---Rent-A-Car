...
class BookingForm(FlaskForm):
    ...
    payment_method = SelectField('Preferred Payment Method', choices=[('Cash', 'Cash on Pickup'), ('GCash', 'GCash'), ('Card', 'Credit/Debit Card')], validators=[DataRequired()])  # Payment method selection
